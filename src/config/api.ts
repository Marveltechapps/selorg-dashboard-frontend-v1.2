...
export const API_ENDPOINTS = {
  ...
  finance: {
    ...
    pickerWithdrawals: {
      ...
      earningsBreakdown: (pickerId: string) => `/finance/picker-withdrawals/${pickerId}/earnings-breakdown`,
      walletBalance: (pickerId: string) => `/finance/picker-withdrawals/${pickerId}/wallet-balance`,
    },
    pickerTransactions: '/finance/picker-transactions',
  ...
  admin: {
    ...
    pickers: {
      ...
      approveDocument: (id: string) => `/admin/pickers/${id}/documents/review`,
      trainingProgress: (id: string) => `/admin/pickers/${id}/training-progress`,
      reviewBankAccount: (id: string, accountId: string) => `/admin/pickers/${id}/bank/${accountId}/review`,
      faceVerification: (id: string) => `/admin/pickers/${id}/face-verification`,
      overrideFaceVerification: (id: string) => `/admin/pickers/${id}/face-verification/override`,
    ...
    trainingVideos: {
      ...
      pickerProgress: '/admin/training-videos/picker-progress',
    },
    pickerConfig: {
